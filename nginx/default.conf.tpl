server {
  ...
  add_header Access-Control-Allow-Headers 'Accept,Authorization,Cache-Control,Content-Range,Content-Type,DNT,If-Modified-Since,Keep-Alive,Origin,Range,User-Agent,X-CustomHeader,X-Requested-With' always;
